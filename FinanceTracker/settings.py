...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-1o!_f1-pnc7pp83(i!rc%f)psi3gwro4zr+^ca90^9m#g9k692')
...
if DATABASE_ENGINE == 'postgresql':
    DATABASES = {
        'default': {
            ...
            'NAME': os.environ.get('DATABASE_NAME', 'financetracker'),
